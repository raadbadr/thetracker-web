-- ============================================================
-- 0055 — ملخص الأسبوع يسقط إلى updated_at للصفوف بلا ختم إنجاز
-- التعبئة الأولية غطت الموجود، وهذا يضمن الصفوف التي قد تدخل من
-- مسار لا يمر بالمحفز فلا يبقى منجز بلا تاريخ.
-- ============================================================
