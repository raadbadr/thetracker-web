...
alter table public.profiles
  add constraint profiles_time_format_check check (time_format in ('12','24'));
...
begin
  ...
  select coalesce(jsonb_agg(jsonb_build_object(
      ...
      'email', p.email, 'lang', p.lang, 'tz', coalesce(p.tz, 'Asia/Riyadh'),
      'time_format', coalesce(p.time_format, '24'), 'external_id', cl.external_id
