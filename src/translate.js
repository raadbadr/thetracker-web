/* ترجمة العرض التلقائية: نص حر كتبه مستخدم بلغة يظهر لمستخدم آخر بلغة واجهته.
   - كشف لغة المصدر من الحروف (عربي / أردو / لاتيني)، ولا يترجم ما لغته لغة الهدف أو ما هو أرقام ورموز فقط.
   - تخزين مؤقت في القاعدة بمفتاح sha256(الهدف + النص) عبر دالتي RPC محميتين بسر الـ Worker.
