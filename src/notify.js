...
الشركة: ${org}` : ""}`\nالشركة: ${org}` : ""}\nستصلك تنبيهات مواعيدك هنا.`,
        ...
        alreadyLinked: (name) => `أنت مرتبط${name ? ` يا ${name}` : ""}. اكتب طلبك أو استعمل الأزرار.` يا ${name}` : ""} ✅\nستصلك تنبيهات مواعيدك هنا تلقائيا.`,
...
Company: ${org}` : ""}`\nCompany: ${org}` : ""}\nYour reminders will arrive here.`,
        ...
        alreadyLinked: (name) => `You are linked${name ? `, ${name}` : ""}. Type your request or use the buttons.`, ${name}` : ""} ✅\nYour reminders will arrive here automatically.`,
...
Societe : ${org}` : ""}`\nSociété : ${org}` : ""}\nVos rappels arriveront ici.`,
        ...
        alreadyLinked: (name) => `Compte lie${name ? `, ${name}` : ""}. Ecrivez votre demande ou utilisez les boutons.`, ${name}` : ""} ✅\nVos rappels arriveront ici automatiquement.`,
