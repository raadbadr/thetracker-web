// --- مساعد الموقع (LLM) --------------------------------------------------
// POST /api/assistant — نفس نمط باركينزي: Claude إن وُجد ANTHROPIC_API_KEY،
// وإلا Workers AI المجاني (env.AI عبر [ai] في wrangler.toml)، وإلا 503
// فتتحول الواجهة تلقائياً لمسار "تواصل مع الدعم".
...
function toolAppInfo() {
  return {
    ...
    features: [
      "لوحة المخالفات: جدول برقم المخالفة وتاريخها والشركة وجهة الإصدار والمبلغ ونوعها وحالة التظلم وموعد السداد، مع مؤشرات بيانية ومجاميع المبالغ ومرشّح حسب الشركة",
      "لوحة القضايا: نفس الفكرة للقضايا والجلسات، ورقم الدعوى يجمع المخالفة وقضيتها وملفاتها في ملف واحد",
      "استيراد ذكي لملف التقرير الشامل: يقرأ أوراق «مخالفات بلدي - <الشركة>» و«جدول الجلسات» و«القضايا المقيدة في معين» ويكتشف صف العناوين تلقائياً ويأخذ اسم الشركة من اسم الورقة",
      ...
      "أرقام قياسية لكل مستخدم وشركة وعنصر (USR / ORG / ITM)"
    ],
    how_it_works: [
      "سجّل حسابك ثم أنشئ شركتك",
      "ارفع ملف إكسل (أو التقرير الشامل للمخالفات والجلسات) من صفحة الاستيراد؛ يكتشف النظام الأعمدة تلقائياً ويمكنك تعديل المطابقة",
