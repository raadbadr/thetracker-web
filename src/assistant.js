...
function toolAppInfo() {
  return {
    ...
    payment: "لا توجد باقة مجانية دائمة: تبدأ كل شركة بفترة تجريبية 14 يوما بكل المزايا، ثم تشترك شهريا أو سنويا. الاشتراكات تفعل حاليا بالتواصل مع الدعم؛ بوابة الدفع الإلكتروني قادمة.",
  };
}
