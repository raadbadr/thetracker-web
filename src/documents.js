...
const KIND_RULES = [
  ...
  { kind: "power_of_attorney", test: /وكالة\s*(?:شرعية|عامة|خاصة)?|توكيل|power\s*of\s*attorney/i, issuer: "وزارة العدل",
    number: ["رقم\\s*الوكالة", "رقم\\s*التوثيق", "الرقم"], numPat: "\\d{6,20}", party: ["الموكل", "اسم\\s*الموكل"] },
  { kind: "court_ruling", test: /حكم|صك\s*حكم|قرار\s*(?:المحكمة|الدائرة)|judg?ment|ruling/i, issuer: "وزارة العدل",
  ...
  { kind: "violation", test: /مخالفة|غرامة|violation|fine\s*notice|ticket/i,
  ...
  { kind: "license", test: /رخصة|ترخيص|تصريح|licen[cs]e|permit/i,
  ...
  { kind: "contract", test: /عقد|اتفاقية|contract|agreement/i,
